...
class AnalyzeProductCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'analyze:product
     ...
     * @var string
     */
    protected $description = 'Analyze a product page for APPROVE integration selectors';
    ...
    public function handle(SelectorMatcher $matcher): int
    {
        ...
        $this->info('Fetching and analyzing product page...');
        $results = $matcher->analyzeProductPage($url);
