...
class AnalyzeCartCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'analyze:cart
                            {url : The cart page URL to analyze}
     ...
     * @var string
     */
    protected $description = 'Analyze a cart page for APPROVE integration selectors';
    ...
    public function handle(SelectorMatcher $matcher): int
    {
        ...
        $this->info('Fetching and analyzing cart page...');
        $results = $matcher->analyzeCartPage($url);
